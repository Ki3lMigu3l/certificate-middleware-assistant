<div align="center">
  <img src="docs/banner.svg" alt="Certificate Middleware Assistant" width="100%"/>
  <br/>
  <br/>
...
> *"O melhor software nasce de um problema real, sentido por uma pessoa real."*
...
<table>
  <tr>
    <td align="center" width="50%">
      <br/>
      <i>Screenshot da tela principal — em breve</i>
      <br/><br/>
    </td>
    <td align="center" width="50%">
      <br/>
      <i>Screenshot do processo de instalação — em breve</i>
      <br/><br/>
    </td>
  </tr>
</table>
...
|-----------------|-------------------|-------------|
| SafeNet Authentication Client | macOS 11 – 15 (Big Sur → Sequoia) | Apple Silicon + Intel |
...
>  O Pacote de Compatibilidade com o macOS 14.0 Sonoma não é necessário após atualização para macOS 14.1 ou superior, conforme orientação oficial da Thales Group.
...
2. Crie uma branch para sua feature
   ...
   ```
3. Faça commit das alterações seguindo [Conventional Commits](https://www.conventionalcommits.org/pt-br/)
   ```bash
...
4. Envie para sua branch
   ...
   ```
5. Abra um Pull Request descrevendo as mudanças e a motivação
...
<div align="center">
  <sub>Construído para a comunidade jurídica e de TI brasileira · Aberto a contribuições de todo o mundo</sub>
</div>
